...
$l['redirect_width'] = "50%";
$l['lastvisit_never'] = "Chưa từng";

$l['toplinks_memberlist'] = "Danh sách thành viên";
$l['toplinks_search'] = "Tìm kiếm";
$l['toplinks_calendar'] = "Lịch";
$l['toplinks_help'] = "Trợ giúp";
$l['toplinks_portal'] = "Tổng hợp";
$l['bottomlinks_contactus'] = "Liên hệ";
$l['bottomlinks_returntop'] = "Về đầu";
$l['bottomlinks_returncontent'] = "Chuyển đến nội dung chính";
$l['bottomlinks_syndication'] = "RSS";
$l['bottomlinks_litemode'] = "Dạng tối giản";

$l['welcome_usercp'] = "Bảng người dùng";
$l['welcome_modcp'] = "Bảng duyệt";
$l['welcome_admin'] = "Admin CP";
$l['welcome_logout'] = "Thoát";
$l['welcome_login'] = "Đăng nhập";
$l['welcome_register'] = "Đăng ký";
$l['welcome_open_buddy_list'] = "Mở vòng bạn bè";
$l['welcome_newposts'] = "Xem những bài viết mới (bạn chưa từng đọc)";
$l['welcome_todaysposts'] = "Xem những bài viết trong ngày hôm nay";
$l['welcome_pms'] = "Hộp tin nhắn";
$l['welcome_pms_usage'] = "({1} chưa đọc, tổng {2})";
$l['welcome_back'] = "<strong>Chào bạn {1}</strong>! Lần cuối bạn ghé thăm là: {2}";
$l['welcome_guest'] = "Xin chào khách qua chơi!";
$l['welcome_current_time'] = "<strong>Giờ hiện tại:</strong> {1}";

$l['moved_prefix'] = "Đã chuyển:";
$l['sticky_prefix'] = "<strong>Dính:</strong>";
$l['poll_prefix'] = "Bình chọn:";
$l['announcement_prefix'] = "<strong>Thông báo:</strong>";

$l['forumbit_announcements'] = "Các thông báo";
$l['forumbit_stickies'] = "Các chủ đề quan trọng";
$l['forumbit_forum'] = "Diễn đàn";
$l['forumbit_threads'] = "Câu chuyện";
$l['forumbit_posts'] = "Bình luận";
$l['forumbit_lastpost'] = "Nội dung gần đây";
$l['forumbit_moderated_by'] = "Phê duyệt bởi:";
$l['new_posts'] = "Diễn đàn có bài viết mới";
$l['no_new_posts'] = "Diễn đàn không có gì mới";
$l['click_mark_read'] = "Đánh dấu diễn đàn đã đọc";
$l['forum_locked'] = "Diễn đàn đã bị khoá";
$l['lastpost_never'] = "Chưa từng";
$l['viewing_one'] = " (Một ai đó đang xem cùng bạn)";
$l['viewing_multiple'] = " (Có {1} ai đó đang xem))";
$l['by'] = "bởi";
$l['more_subforums'] = "và {1} nữa.";

$l['password_required'] = "Cần phải có mật khẩu";
$l['forum_password_note'] = "Nội dung bí mật nên quản trị viên đã đặt mật khẩu cho trang.";
$l['enter_password_below'] = "Hãy nhập mật khẩu phía dưới";
$l['verify_forum_password'] = "Xác nhận lại";
$l['wrong_forum_password'] = "Mật khẩu bạn nhập không chính xác.";

$l['reset_button'] = "Khôi phục";
$l['username'] = "Username:";
$l['username1'] = "Email:";
...
$l['remember_me_desc'] = "Bạn sẽ luôn đăng nhặp khi mở ra.";
...
$l['attachments_desc'] = "Bạn có đính kèm hình ảnh hay tài liệu.";
$l['remove_attachment'] = "Gỡ bỏ";
$l['approve_attachment'] = "Chấp thuận";
$l['unapprove_attachment'] = "Huỷ bỏ";
$l['insert_attachment_post'] = "Chèn vào bên trong bài viết";
$l['new_attachment'] = "Thêm đính kèm:";
$l['add_attachment'] = "Thêm đính kèm";
$l['update_attachment'] = "Sửa đính kèm";
$l['post_preview'] = "Xem thử";
$l['change_user'] = "đổi người dùng";
$l['post_icon'] = "Tâm trạng bài viết:";
$l['no_post_icon'] = "no icon";
$l['thread_subscription_method'] = "Thiết lập thông báo";
$l['no_subscribe'] = "Không thông báo";
$l['no_email_subscribe'] = "Có thông báo";
$l['instant_email_subscribe'] = "Gửi email nếu có gì mới";
...
$l['postbit_attachments'] = "Đính kèm";
$l['postbit_attachment_size'] = "Kích thước:";
$l['postbit_attachment_downloads'] = "Lượt tải về:";
$l['postbit_attachments_images'] = "Ảnh";
$l['postbit_attachments_thumbnails'] = "Hình thu nhỏ";
$l['postbit_unapproved_attachments'] = "{1} đính kèm chưa duyệt.";
$l['postbit_unapproved_attachment'] = "1 đíh kèm chưa duyệt.";
$l['postbit_status_online'] = "Online";
$l['postbit_status_offline'] = "Offline";
$l['postbit_status_away'] = "Đi vắng";
$l['postbit_edited'] = "Sửa lần cuối {1} {2} bởi";
$l['postbit_ipaddress'] = "IP:";
$l['postbit_ipaddress_logged'] = "Logged";
$l['postbit_post'] = "Đã đăng:";
$l['postbit_reputation'] = "Uy tín:";
$l['postbit_reputation_add'] = "Tăng thêm uy tín cho người này";
$l['postbit_website'] = "Xem trang web";
$l['postbit_email'] = "Gửi email";
